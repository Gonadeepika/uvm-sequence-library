...
help:
	...
	@echo "! run_test	=>  clean, compile & run the simulation for ram_seq_lib_test in batch mode.		!" 
	@echo ====================================================================================================================
...
run_test_Questa: clean sv_cmp
	vsim  $(VSIMOPT) $(VSIMCOV) $(VSIMBATCH1)  -l test1.log  -sv_seed random  work.top +UVM_TESTNAME=ram_seq_lib_test
...
run_test_VCS:	clean  sv_cmp_VCS
	./simv -a test.log +ntb_random_seed_automatic +UVM_TESTNAME=ram_seq_lib_test
